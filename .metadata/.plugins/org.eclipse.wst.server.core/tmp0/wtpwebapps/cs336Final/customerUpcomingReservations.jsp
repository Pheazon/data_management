...
try{
	...
	%>
		...
		<input type="submit", value="See my upcoming flights">
		</form>
	<%
		...
		String command = "SELECT r.DateBooked, r.ReservationNumber, r.TotalFare, f.DepartureTime, f.ArrivalTime, r.FlightNumber, r.type, f.departingFrom, f.arrivingTo, f.airlineID, r.class, f.dom_int FROM Flight f, Reservation r WHERE r.userid='" + userid + "' AND r.FlightNumber = f.FlightNumber AND f.DepartureTime>'" + today + "'";

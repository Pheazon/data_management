...
<br>
	...
	<%
		...
		Statement statement = con.createStatement();
			String command = "SELECT FlightNumber, Fare, airlineID, departingFrom, arrivingTo, DepartureTime, ArrivalTime, dom_int FROM Flight WHERE fare<'" + pmax + "' AND fare>'" + pmin + "' AND departingFrom LIKE '%" + departure + "%' AND arrivingTo LIKE '%" + arrival + "%' AND airlineID LIKE '%" + airline + "%' AND dom_int LIKE '%" + domint + "%'" + archive + sortby;
